...
const socialLinks = [
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com/in/lanre-phillips-dr-9702aa5",
    icon: (
      <svg
        className="w-6 h-6"
        fill="currentColor"
  ...
  {
    name: "Instagram",
    href: "https://www.instagram.com/drlanrephillips?igsh=MWJwYTBtdXo1dzd1dw==",
    icon: (
      <svg
        className="w-6 h-6"
        fill="currentColor"
    ...
    <section className="relative overflow-hidden bg-gradient-to-br from-slate-900 via-slate-800 to-neutral-900">
      ...
      <div className="relative mx-auto max-w-5xl px-6 py-20 md:py-28">
        ...
        >
          ...
          >
            Stay Connected{" "}
            <span className="text-neutral-500">Dr. Lanre Phillips</span>
          </h2>
